    ...
    <div className='flex justify-center items-start px-4 py-6'>
      <div className='w-full max-w-3xl bg-white dark:bg-neutral-900 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-700 overflow-hidden'>
        <div className='px-8 py-5 border-b border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800/60'>
          <h2 className='text-xl font-semibold text-neutral-900 dark:text-neutral-100'>Delete Event</h2>
          <p className='text-sm text-neutral-500 dark:text-neutral-400 mt-0.5'>Look up an event by ID to delete it.</p>
        </div>
        {!eventDeleted && <section className='px-8 py-6'>
          ...
          <div className='flex gap-3'>
            <input
              ...
              value={eventId}
              onChange={(e) => { setEventId(e.target.value); setEventDeleted(false); }}
            />
            <button
              type="button"
        ...
        {
          eventDeleted && <div className='px-8 py-6'>
            <h3 className={sectionHeadingClass}>Event Deleted</h3>
            <p className='text-sm text-neutral-500 dark:text-neutral-400'>Event with ID &quot;{eventId}&quot; has been deleted.</p>
          </div>
        }
      </div>
    </div>
